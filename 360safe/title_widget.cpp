...
TitleWidget::TitleWidget(QWidget *parent)
	: QWidget(parent)
{
    version_title = new QLabel();//标题
    skin_button = new PushButton();//换肤
    main_menu_button = new PushButton();//主菜单
    min_button = new PushButton();//最小化
    feedback_button = new PushButton();//反馈意见
    close_button = new PushButton();//关闭
    ...
    QHBoxLayout *title_layout = new QHBoxLayout();//水平布局
