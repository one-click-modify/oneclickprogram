...
private:
    ...
    QStackedLayout *main_stacked_layout; //新浪、电信一键式、人人网界面
    QStackedLayout *stacked_layout; //一键式、人人网界面
    QStackedLayout *login_stacked_layout; //一键式、登录验证界面
	QWidget *safe_renren_center_widget;

    QWidget *safe_renren_widget; //一键式界面
	QWidget *safe_widget;
	QLabel *icon_label;
	QLabel *safe_label;
    ...
    QCheckBox *safe_attention_check_box; //关注一键式
